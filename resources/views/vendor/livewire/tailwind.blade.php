<div>
    @if ($paginator->hasPages())
        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
            ...
            <div class="flex-wrap hidden sm:flex sm:items-center sm:justify-center">
                                    ...
                                    <span wire:key="paginator-{{ $paginator->getPageName() }}-{{ $this->numberOfPaginatorsRendered[$paginator->getPageName()] }}-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-gray-500 bg-[#FEB000] border border-[#FEB000] cursor-default select-none">{{ $page }}</span>
                                            </span>
                                        @else
