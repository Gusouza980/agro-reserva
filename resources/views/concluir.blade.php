...
<div class="py-14 px-4 md:px-0 px-md-0 w1200 2xl:mx-auto">
    <div class="flex justify-start item-start space-y-2 flex-col">
        <h1 class="text-3xl  lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">Pedido #{{ $venda->codigo }}</h1>
            ...
            <div class="flex flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0">
                <div class="flex flex-col justify-start items-start flex-shrink-0">
                    <div class="flex justify-center w-full md:justify-start items-center space-x-4 py-8 border-b border-gray-200">
                        <div class="flex justify-start items-start flex-col space-y-2">
                            <p class="text-base  font-semibold leading-4 text-left text-gray-800">Luis Gustavo de Souza Carvalho</p>
                            <p class="text-sm  leading-5 text-gray-600">4 Compras Realizadas</p>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center text-gray-800  md:justify-start items-center space-x-4 py-4 border-b border-gray-200 w-full">
                        ...
                        <p class="cursor-pointer text-sm leading-5 ">gusouza980@gmail.com</p>
                    </div>
                </div>
                <div class="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                    <div class="flex justify-center md:justify-start xl:flex-col flex-col md:space-x-6 lg:space-x-8 xl:space-x-0 space-y-4 xl:space-y-12 md:space-y-0 md:flex-row items-center md:items-start">
                        <div class="flex justify-center md:justify-start items-center md:items-start flex-col space-y-4 xl:mt-8">
                            ...
                            <p class="w-48 lg:w-full  xl:w-48 text-center md:text-left text-md-left  text-sm leading-5 text-gray-600">15x de R$2000</p>
                        </div>
                        <div class="flex justify-center md:justify-start items-center md:items-start flex-col space-y-4">
                            ...
                            <p class="w-48 lg:w-full  xl:w-48 text-center md:text-left text-md-left text-sm leading-5 text-gray-600">Zé Victor</p>
                        </div>
                    </div>
                    <div class="flex flex-col gap-2 w-full justify-center items-center md:justify-start md:items-start">
                        <button class="mt-6 py-2 bg-orange-600 text-white hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 border border-gray-800 font-medium w-96 2xl:w-full text-base leading-4">Conversar com assessor</button>
                        <button class="mt-0 py-2 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 border border-gray-800 font-medium w-96 2xl:w-full text-base leading-4 text-gray-800">Ver minhas compras</button>
                    </div>
                </div>
            </div>
        </div>
