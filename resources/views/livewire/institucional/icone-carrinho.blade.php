<div x-data="{count: 0}" x-ref="iconeCarrinho" class="w-full relative @if(!session()->get("carrinho")) hidden @endif" @click="openSideCart = !openSideCart"
...
>
    ...
    Meu Caminhão
    <div class="w-[20px] h-[20px] bg-[#EE682A] text-white flex items-center justify-center absolute top-0 right-[5px] rounded-full" x-text="count">
    ...
    <script>
        ...
        myComponentElement.addEventListener('atualizaContagemLotes', (event) => {
            alert("CHEGOU")
            Alpine.executeMethod(myComponentElement, 'setCount', event.detail);
        });
