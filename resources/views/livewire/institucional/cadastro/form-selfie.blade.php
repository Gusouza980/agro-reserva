    ...
    <div x-cloak x-show="showFormSelfie" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="w-full px-20 py-24 mt-3 bg-white rounded-t-lg shadow-[6px_6px_20px_rgba(36,62,111,0.11)]">
            ...
            <div class="w-full mt-3 text-center">
                ...
                <img id="preview-upload" class="max-w-full my-5" style="display: none;" src="" alt="">
            </div>
            <div class="grid w-full grid-cols-1 mt-5 text-center md:grid-cols-2 gap-y-10 md:gap-y-0">
                <div class="flex items-center justify-center">
                    ...
                    <input id="input_selfie" class="hidden" type="file" accept="image/*" capture>
                </div>
