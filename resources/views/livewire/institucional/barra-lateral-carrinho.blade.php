                                ...
                                @foreach($carrinho->produtos as $produto)
                                    <div class="flex py-3 flex-collumn space-x-6">
                                        ...
                                        <div class="relative">
                                            ...
                                            <i class="absolute -right-[15px] duration-300 text-[#5C6384] hover:text-[#15171E] top-2 fa-solid fa-trash-can text-[20px] hover:scale-110 cpointer" wire:click="removerProduto({{ $carrinho->id }}, {{ $produto->id }})"></i>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
