<div class="w-full text-center mt-[65px]">
    <h2 class="text-[20px] font-medium text-[#15171E]">Dados Pessoais | Pessoa Jurídica</h2>
</div>
<div class="w-full mt-[30px]">
    <div class="w-full grid grid-cols-1 md:grid-cols-5 gap-3">
        <div class="mb-5 md:col-span-2">
            ...
            <input type="text" name="form.cnpj" class="w-full form-input-text mt-[5px]" mask="cnpj" wire:model.defer="form.cnpj" maxlength="50">
        ...
        <div class="mb-5 md:col-span-3">
            ...
            <input type="text" name="form.nome_fantasia" class="w-full form-input-text mt-[5px]" wire:model.defer="form.nome_fantasia" maxlength="100">
            <div class="w-full text-[12px] text-red-600 font-inter">
                @error('form.nome_fantasia')
                    {{ $message }}
                @enderror
            </div>
        </div>
    ...
    <div class="w-full grid grid-cols-1 md:grid-cols-3 gap-3">
        <div class="mb-5">
            ...
            <input type="text" name="form.cep_comercial" class="w-full form-input-text mt-[5px]" x-on:change="$wire.set('form.cep_comercial', $event.target.value)" mask="cep" wire:model.defer="form.cep_comercial" maxlength="9">
            <div class="w-full text-[12px] text-red-600 font-inter">
        ...
        <div class="mb-5 md:col-span-2">
            ...
            <input type="text" name="form.rua_comercial" class="w-full form-input-text mt-[5px]" wire:loading.attr="disabled" wire:target="form.cep_comercial" wire:model.defer="form.rua_comercial" maxlength="255">
            <div class="w-full text-[12px] text-red-600 font-inter">
    ...
    <div class="w-full grid grid-cols-2 md:grid-cols-6 gap-3">
        <div class="mb-5">
            ...
            <input type="text" name="form.numero_comercial" class="w-full form-input-text mt-[5px]" wire:loading.attr="disabled" wire:target="form.cep_comercial" wire:model.defer="form.numero_comercial" maxlength="6">
            <div class="w-full text-[12px] text-red-600 font-inter">
        ...
        <div class="mb-5 md:col-span-2">
            ...
            <input type="text" name="form.bairro_comercial" class="w-full form-input-text mt-[5px]" wire:loading.attr="disabled" wire:target="form.cep_comercial" wire:model.defer="form.bairro_comercial" maxlength="50">
            <div class="w-full text-[12px] text-red-600 font-inter">
        ...
        <div class="mb-5 col-span-2 md:col-span-3">
            ...
            <input type="text" name="form.complemento_comercial" class="w-full form-input-text mt-[5px]" wire:loading.attr="disabled" wire:target="form.cep_comercial" wire:model.defer="form.complemento_comercial" maxlength="50">
            <div class="w-full text-[12px] text-red-600 font-inter">
    ...
    <div class="w-full grid grid-cols-2 md:grid-cols-3 gap-3">
        <div class="mb-5 col-span-2 md:col-span-1">
            ...
            <input type="text" name="form.cidade_comercial" class="w-full form-input-text mt-[5px]" wire:loading.attr="disabled" wire:target="form.cep_comercial" wire:model.defer="form.cidade_comercial" maxlength="50">
            <div class="w-full text-[12px] text-red-600 font-inter">
        ...
        <div class="mb-5">
            ...
            <select name="form.estado_comercial" class="w-full form-input-text mt-[5px]" wire:loading.attr="disabled" wire:target="form.cep_comercial" wire:model.defer="form.estado_comercial">
        ...
        <div class="mb-5">
            ...
            <input type="text" name="form.pais_comercial" class="w-full form-input-text mt-[5px]" wire:loading.attr="disabled" wire:target="form.cep_comercial" wire:model.defer="form.pais_comercial" maxlength="50">
            <div class="w-full text-[12px] text-red-600 font-inter">
    ...
    <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-3 items-end">
        <div class="mb-5 relative" >
            ...
            <div class="w-full" wire:loading.class="blur-sm" wire:target="contrato_social">
                <label name="contrato_social" for="input-contrato-social" class="hover:shadow-md transition duration-200 cursor-pointer w-full h-[95px] px-5 rounded-t-md border border-[#C7C9D3] flex items-center justify-center gap-3">
                    <div>
                ...
                <div class="w-full px-2 border border-t-0 rounded-b-md border-slate-300 text-gray-500 text-sm">
                    @if(count($contratos_sociais) > 0)
                        @foreach($contratos_sociais as $key => $contrato_social)
                            @if($contrato_social)
                                <div class="w-full py-3 px-2 border-b border-slate-300 flex justify-between items-center">
                                    <div>
                                        {{ $contrato_social->getClientOriginalName() }}
                                    </div>
                                    <div>
                                        <button type="button" wire:click="removerUpload('contratos_sociais',{{ $key }})" class="bg-none border border-gray-600 w-6 h-6 flex items-center justify-center rounded-full hover:border-red-500 hover:text-red-500">
                ...
                <input type="file" id="input-contrato-social" wire:model="contrato_social" class="hidden" multiple>
