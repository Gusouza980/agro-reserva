<div class="w-full text-center mt-[65px]">
    <h2 class="text-[20px] font-medium text-[#15171E]">Dados da Propriedade Rural</h2>
</div>
<div class="w-full mt-[30px]">
    <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-3">
        <div class="mb-5">
            <label class="pl-[20px] text-[16px] font-medium font-montserrat text-[#616887]" for="">Nome da Fazenda</label>
            <input type="text" name="form.nome_fazenda" class="w-full form-input-text mt-[5px]" wire:model.defer="form.nome_fazenda" maxlength="150">
        ...
        <div class="mb-5">
            ...
            <input type="text" name="form.inscricao_produtor_rural" class="w-full form-input-text mt-[5px]" wire:model.defer="form.inscricao_produtor_rural" maxlength="20">
            <div class="w-full text-[12px] text-red-600 font-inter">
    ...
    <div class="w-full grid grid-cols-1 md:grid-cols-3 gap-3">
        <div class="mb-5">
            ...
            <input type="text" name="form.cep_propriedade" class="w-full form-input-text mt-[5px]" x-on:change="$wire.set('form.cep_propriedade', $event.target.value)" mask="cep" wire:model.defer="form.cep_propriedade" maxlength="9">
            <div class="w-full text-[12px] text-red-600 font-inter">
    ...
    <div class="w-full grid grid-cols-2 md:grid-cols-6 gap-3">
        <div class="mb-5">
            ...
            <input type="text" name="form.numero_propriedade" class="w-full form-input-text mt-[5px]" wire:loading.attr="disabled" wire:target="form.cep_propriedade" wire:model.defer="form.numero_propriedade" maxlength="6">
            <div class="w-full text-[12px] text-red-600 font-inter">
        ...
        <div class="mb-5 md:col-span-2">
            ...
            <input type="text" name="form.bairro_propriedade" class="w-full form-input-text mt-[5px]" wire:loading.attr="disabled" wire:target="form.cep_propriedade" wire:model.defer="form.bairro_propriedade" maxlength="50">
            <div class="w-full text-[12px] text-red-600 font-inter">
        ...
        <div class="mb-5 col-span-2 md:col-span-3">
            ...
            <input type="text" name="form.complemento_propriedade" class="w-full form-input-text mt-[5px]" wire:loading.attr="disabled" wire:target="form.cep_propriedade" wire:model.defer="form.complemento_propriedade" maxlength="50">
            <div class="w-full text-[12px] text-red-600 font-inter">
    ...
    <div class="w-full grid grid-cols-2 md:grid-cols-3 gap-3">
        <div class="mb-5 col-span-2 md:col-span-1">
            ...
            <input type="text" name="form.cidade_propriedade" class="w-full form-input-text mt-[5px]" wire:loading.attr="disabled" wire:target="form.cep_propriedade" wire:model.defer="form.cidade_propriedade" maxlength="50">
            <div class="w-full text-[12px] text-red-600 font-inter">
        ...
        <div class="mb-5">
            ...
            <select class="w-full form-input-text mt-[5px]" name="form.estado_propriedade" wire:loading.attr="disabled" wire:target="form.cep_propriedade" wire:model.defer="form.estado_propriedade">
        ...
        <div class="mb-5">
            ...
            <input type="text" name="form.pais_propriedade" class="w-full form-input-text mt-[5px]" wire:loading.attr="disabled" wire:target="form.cep_propriedade" wire:model.defer="form.pais_propriedade" maxlength="50">
            <div class="w-full text-[12px] text-red-600 font-inter">
    ...
    <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-3 items-end">
        <div class="mb-5 relative" >
            ...
            <div class="w-full" wire:loading.class="blur-sm" wire:target="ficha_sanitaria">
                <label name="ficha_sanitaria" for="input-ficha_sanitaria" class="hover:shadow-md transition duration-200 cursor-pointer w-full h-[95px] px-5 rounded-t-md border border-[#C7C9D3] flex items-center justify-center gap-3">
                    <div>
                ...
                <div class="w-full px-2 border border-t-0 rounded-b-md border-slate-300 text-gray-500 text-sm">
                    @if(count($fichas_sanitarias) > 0)
                        @foreach($fichas_sanitarias as $key => $ficha_sanitaria)
                            @if($ficha_sanitaria)
                                <div class="w-full py-3 px-2 border-b border-slate-300 flex justify-between items-center">
                                    <div>
                                        {{ $ficha_sanitaria->getClientOriginalName() }}
                                    </div>
                                    <div>
                                        <button type="button" wire:click="removerUpload('fichas_sanitarias',{{ $key }})" class="bg-none border border-gray-600 w-6 h-6 flex items-center justify-center rounded-full hover:border-red-500 hover:text-red-500">
                ...
                <input type="file" id="input-ficha_sanitaria" wire:model="ficha_sanitaria" class="hidden" multiple>
        ...
        <div class="mb-5 relative" >
            ...
            <div class="w-full" wire:loading.class="blur-sm" wire:target="matricula_imovel">
                <label name="matricula_imovel" for="input-matricula_imovel" class="hover:shadow-md transition duration-200 cursor-pointer w-full h-[95px] px-5 rounded-t-md border border-[#C7C9D3] flex items-center justify-center gap-3">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="44" viewBox="0 0 52 44" fill="none">
                            <path d="M41.0281 31.0222C42.404 31.0239 43.7648 30.7293 45.0222 30.1573C46.2797 29.5853 47.4055 28.7487 48.3267 27.702C49.2479 26.6553 49.9437 25.4218 50.3691 24.0817C50.7944 22.7416 50.9397 21.3248 50.7955 19.9234C50.6514 18.5221 50.221 17.1674 49.5323 15.9475C48.8436 14.7276 47.912 13.6697 46.7981 12.8426C45.6841 12.0155 44.4128 11.4377 43.0665 11.1466C41.7203 10.8556 40.3294 10.8578 38.9841 11.1532C38.2081 8.17859 36.4949 5.54954 34.1105 3.67428C31.7261 1.79902 28.8039 0.782471 25.7976 0.782471C22.7913 0.782471 19.869 1.79902 17.4846 3.67428C15.1002 5.54954 13.387 8.17859 12.6111 11.1532C11.2658 10.8578 9.87482 10.8556 8.52861 11.1466C7.18239 11.4377 5.91102 12.0155 4.79709 12.8426C3.68315 13.6697 2.75158 14.7276 2.06288 15.9475C1.37418 17.1674 0.943768 18.5221 0.799602 19.9234C0.655435 21.3248 0.800741 22.7416 1.22608 24.0817C1.65142 25.4218 2.34727 26.6553 3.26844 27.702C4.1896 28.7487 5.31547 29.5853 6.5729 30.1573C7.83033 30.7293 9.19119 31.0239 10.5671 31.0222H41.0281Z" fill="#EDF5FF"/>
                            <path d="M25.7968 43.2036C32.3657 43.2036 37.6908 37.7497 37.6908 31.0221C37.6908 24.2944 32.3657 18.8406 25.7968 18.8406C19.228 18.8406 13.9028 24.2944 13.9028 31.0221C13.9028 37.7497 19.228 43.2036 25.7968 43.2036Z" fill="#62E8A2"/>
                ...
                <div class="w-full px-2 border border-t-0 rounded-b-md border-slate-300 text-gray-500 text-sm">
                    @if(count($matriculas_imoveis) > 0)
                        @foreach($matriculas_imoveis as $key => $matricula_imovel)
                            @if($matricula_imovel)
                                <div class="w-full py-3 px-2 border-b border-slate-300 flex justify-between items-center">
                                    <div>
                                        {{ $matricula_imovel->getClientOriginalName() }}
                                    </div>
                                    <div>
                                        <button type="button" wire:click="removerUpload('matriculas_imoveis',{{ $key }})" class="bg-none border border-gray-600 w-6 h-6 flex items-center justify-center rounded-full hover:border-red-500 hover:text-red-500">
                                            <i class="fas fa-xmark text-sm"></i>
                                        </button>
                                    </div>
                                </div>
                ...
                <input type="file" id="input-matricula_imovel" wire:model="matricula_imovel" class="hidden" multiple>
