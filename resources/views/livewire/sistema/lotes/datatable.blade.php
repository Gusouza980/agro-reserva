            ...
            <table class="w-full text-left is-hoverable" style="vertical-align: middle;">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-3 font-semibold uppercase whitespace-nowrap bg-slate-200 text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Nº</th>
                        ...
                        <th class="px-4 py-3 font-semibold uppercase whitespace-nowrap bg-slate-200 text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Ativo</th>
                        <th class="px-4 py-3 font-semibold uppercase whitespace-nowrap bg-slate-200 text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Visitas</th>
                        <th class="px-4 py-3 font-semibold uppercase rounded-tr-lg whitespace-nowrap bg-slate-200 text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5"></th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr class="border-transparent border-y border-b-slate-200 dark:border-b-navy-500">
                            <td class="px-4 py-3 whitespace-nowrap sm:px-5">
                                <label for="input_preview_{{ $lote->id }}" class="cursor-pointer">
                                    <img src="{{ \Util::getImagemOuPadrao($lote->preview) }}" alt="" width="80">
                                </label>
                            ...
                            <td class="px-4 py-3 whitespace-nowrap sm:px-5">
                                <select class="w-full px-3 py-2 bg-transparent border rounded-lg form-input peer border-slate-300 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" onchange="Livewire.emit('atualizaValor', {{ $lote->id }}, 'liberar_preco', this.value)">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap sm:px-5">
                                <select class="w-full px-3 py-2 bg-transparent border rounded-lg form-input peer border-slate-300 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" onchange="Livewire.emit('atualizaValor', {{ $lote->id }}, 'liberar_compra', this.value)">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap sm:px-5">
                                <select class="w-full px-3 py-2 bg-transparent border rounded-lg form-input peer border-slate-300 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" onchange="Livewire.emit('atualizaValor', {{ $lote->id }}, 'ativo', this.value)">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap sm:px-5">
                                <button
                                    class="font-medium text-white bg-gray-600 w-fit h-8 px-3 rounded-md"
