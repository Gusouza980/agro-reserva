            ...
            <table class="table table-hover">
                <tbody>
                    @foreach($resultados as $lote_pesquisa)
                        <tr class="tr-pesquisa cpointer" wire:key='{{ $loop->index }}' onclick="window.location.href='{{ route('fazenda.lote', ['fazenda' => $lote_pesquisa->fazenda->slug, 'lote' => $lote_pesquisa, 'reserva' => $lote_pesquisa->reserva]) }}'">
