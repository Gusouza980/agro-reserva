            ...
            <table class="table table-hover">
                <tbody>
                    @foreach($resultados as $lote)
                        <tr class="tr-pesquisa cpointer" wire:key='{{ $loop->index }}' onclick="window.location.href='{{ route('fazenda.lote', ['fazenda' => $lote->fazenda->slug, 'lote' => $lote, 'reserva' => $lote->reserva]) }}'">
