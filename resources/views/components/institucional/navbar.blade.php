    ...
    <div class="flex flex-wrap items-center justify-between mx-auto w1400 align-items-center">
        ...
        @if(session()->get("cliente"))
            <div class="flex items-end md:order-2" style="font-family: 'Montserrat', sans-serif;">
                ...
                <div class="d-none d-md-block mr-5 mt-2 text-center transition duration-500 cpointer hover:scale-105" style="font-size: 10px;">
                ...
                {{-- BOTÃO MINHA CONTA --}}
                <div class="d-none d-md-block mr-5 text-center transition duration-500 cpointer hover:scale-105" style="font-size: 10px;" aria-expanded="false" type="button" data-dropdown-toggle="dropdown">
