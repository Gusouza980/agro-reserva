    ...
    <div class="flex flex-wrap items-center justify-between mx-auto w1200 align-items-center">
        ...
        @if (session()->get('cliente'))
            <div class="flex items-end md:order-2" style="font-family: 'Montserrat', sans-serif;">
                ...
                <div onclick="window.open('https://api.whatsapp.com/send?phone=5511934320654', '_blank')"  class="mt-2 mr-5 text-center transition duration-500 d-none d-md-block cpointer hover:scale-105"
        ...
        @else
            <div class="flex items-center md:order-2">
                <div onclick="window.open('https://api.whatsapp.com/send?phone=5511934320654', '_blank')" class="mr-5 text-center transition duration-500 d-none d-md-block cpointer hover:scale-105"
                    style="font-size: 10px;">
