<div class="py-5">
    <div class="flex flex-wrap px-3 mx-auto w1200 px-lg-0 justify-content-between align-items-center">
        <div class="flex mb-4 duration-1000 delay-300 align-items-center mb-lg-0 animate-in fade-in">
            <div class="mr-3">
