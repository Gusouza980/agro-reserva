<div class="w-full max-w-[900px] mx-auto py-6">
    <div class="flex">
        <div class="w-1/4">
            ...
            <div class="text-[10px] text-center md:text-sm hidden md:block" style="word-wrap: break-word;">Pré Cadastro</div>
        </div>
        ...
        <div class="w-1/4">
            ...
            <div class="text-[10px] text-center md:text-sm hidden md:block" style="word-wrap: break-word;">Dados Pessoais</div>
        </div>
        ...
        <div class="w-1/4">
            ...
            <div class="text-[10px] text-center md:text-sm hidden md:block" style="word-wrap: break-word;">Dados da Propriedade</div>
        </div>
        ...
        <div class="w-1/4">
            ...
            <div class="text-[10px] text-center md:text-sm hidden md:block" style="word-wrap: break-word;">Informações Complementares</div>
        </div>
        ...
        <div class="w-1/4">
            ...
            <div class="text-[10px] text-center md:text-sm hidden md:block" style="word-wrap: break-word;">Tudo Pronto</div>
        </div>
    </div>
</div>