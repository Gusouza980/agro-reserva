...
@livewire("painel.vendas.detalhes", ["venda" => $venda])
@livewire("painel.vendas.datatable-parcelas", ["venda" => $venda])
@endsection

@section('scripts')
    @livewire("painel.vendas.modal-adiciona-lote", ["venda" => $venda])
