            ...
            <div class="modal-body">
                <form class="row" action="{{ route('painel.cliente.cadastrar') }}" method="post">
                    ...
                    <div class="form-group mb-3 col-12">
                        ...
                        <input type="text" class="form-control" name="nome_dono" maxlength="100" required>
                    </div>
                    <div class="form-group mb-3 col-4">
                        <label for="">Telefone *</label>
                        <input type="text" class="form-control" name="telefone" maxlength="50" required>
                    </div>
                    <div class="form-group mb-3 col-4">
                        <label for="">Whatsapp</label>
                        <input type="text" class="form-control" name="whatsapp" maxlength="50">
                    </div>
                    <div class="form-group mb-3 col-4">
                        <label for="">CPF/CNPJ *</label>
                        <input type="text" class="form-control" name="documento" maxlength="50">
                    </div>
                    <div class="form-group mb-3 col-6">
                        <label for="">Rua</label>
                    ...
                    <div class="form-group mb-3 col-2">
                        ...
                        <input type="text" class="form-control" name="numero" maxlength="6">
                    </div>
                    <div class="form-group mb-3 col-4">
                    ...
                    <div class="form-group col-12 col-lg-3 form-conta mb-3">
                        ...
                        <input type="text" class="form-control" name="estado" id="estado" maxlenght="50"
                            aria-describedby="" placeholder="">
                    </div>
                    <div class="form-group col-12 col-lg-4 form-conta mb-3">
                        <label for="cidade">Cidade</label>
                        <input type="text" class="form-control" name="cidade" id="cidade" maxlenght="50"
                            aria-describedby="" placeholder="">
                    </div>
                    <div class="form-group col-7 col-lg-3 form-conta mb-3">
                        <label for="cep">CEP</label>
                        <input type="text" class="form-control" name="cep" id="cep" aria-describedby="helpId">
                    </div>
