                    ...
                    <tbody>
                        @foreach($vendas as $venda)
                            <tr>
                                ...
                                <td style="vertical-align: middle; text-align:center;">{{$venda->carrinho->cliente->nome_dono}}</td>
                                ...
                                <td><a href="{{route('painel.fazenda.vendas.visualizar', ['venda' => $venda])}}" class="btn btn-primary">Visualizar</a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
