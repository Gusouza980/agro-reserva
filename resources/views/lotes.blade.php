        ...
        <div class="row">
            @foreach($fazenda->lotes->where("ativo", true) as $lote)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 px-3 mt-4">
                        <a href="{{route('fazenda.lote', ['fazenda' => $fazenda->slug, 'lote' => $lote])}}">
                            <div class="row">
                                <div class="col-12 text-center text-lotes">
                                    <img src="{{ asset($lote->preview) }}" style="border-radius: 15px;" alt="">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 text-lotes text-center">
                                    <span style="text-transform: capitalize;">{{$lote->nome}}</span>
                                </div>
                            </div>
                        </a>
                    </div>
