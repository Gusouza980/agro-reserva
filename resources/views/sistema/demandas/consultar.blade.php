...
@section('conteudo')
    <div class="grid justify-center grid-cols-1 px-6 py-6">
        <div class="flex items-center justify-between w-full">
            ...
            <div>
                <button
                    ...
                    onclick="Livewire.emit('carregaModalCadastroDemanda')"
                >
                    Adicionar Demanda
                </button>
            </div>
        ...
        <div class="mt-3 card">
            @livewire('sistema.demandas.pagina')
        </div>
    </div>
    @livewire('sistema.demandas.modal-cadastro')
    @livewire('sistema.demandas.detalhes')
@endsection
