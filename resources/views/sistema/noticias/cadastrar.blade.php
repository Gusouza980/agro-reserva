                    ...
                    <div class="grow">
                        <div class="w-full">
                            <label class="block">
                                ...
                                <input name="titulo" class="w-full px-3 py-2 bg-transparent border rounded-lg form-input peer border-slate-300 placeholder:text-slate-400/70 hover:border-slate-400" type="text" maxlength="255" required>
                            </span>
                            </label>
                        </div>
                    </div>
                    <div class="grow">
                        <div class="w-full">
                            <label class="block">
                                <span>Subtítulo</span>
                                <span class="relative mt-1.5 flex">
                                <input name="subtitulo" class="w-full px-3 py-2 bg-transparent border rounded-lg form-input peer border-slate-300 placeholder:text-slate-400/70 hover:border-slate-400" type="text" maxlength="255">
                            </span>
                            </label>
                        </div>
                    </div>
