...
@section('conteudo')
<div class="container-fluid py-5 min-vh-100" style="background: url({{asset('imagens/bg-home-min.jpg')}}); background-position: bottom; background-size: cover;">
                ...
                @if(!session()->get("cliente"))
                    <form action="{{route('cadastro.salvar')}}" class="row form-cadastro0" method="post">
                        ...
                        <div class="form-group col-12 input-cadastro">
                            ...
                            <input type="text" class="form-control" name="nome" id="nome" aria-describedby="" required placeholder="Informe seu nome completo">
                        </div>
                        <div class="form-group col-12 input-cadastro">
                            <label for="email">E-mail</label>
                            <input type="email" class="form-control" name="email" id="email" aria-describedby="" required placeholder="exemplo@exemplo.com">
                        </div>
                        <div class="form-group col-12 input-cadastro">
                            <label for="telefone">Telefone</label>
                            <input type="text" class="form-control" name="telefone" id="telefone" aria-describedby="" required placeholder="(99) 99999-9999">
                        </div>       
                        <div class="form-group col-12 input-cadastro">
                            <label for="senha">Crie uma senha de acesso</label>
                            <input type="password" class="form-control" name="senha" id="senha" aria-describedby="" required placeholder="******">
                        </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-center modal-precadastro-text">
                                    <h4 style="line-height: 35px; letter-spacing: 1px;">"Simbora"! <b>Sua conta foi criada com sucesso</b>. Mas lembre-se: para finalizar a compra, seu cadastro <b>precisa estar completo e aprovado</b> pelo nosso time. Rápido, prático e seguro! "Bora" preencher agora?</h4>
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-12">
                                    <div class="text-center" id="botoes-finalizar">
                                        <a href="{{route('cadastro.finalizar')}}"><button type="submit" class="btn-vermelho px-4 py-2 mt-3">Completar Agora</button></a>
