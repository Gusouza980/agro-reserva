                        ...
                        <div class="product__gallery">
                            <div class="product-gallery">
                                <div class="product-gallery__featured"><button class="product-gallery__zoom"><svg
                                            ...
                                            <use xlink:href="{{ asset('marketplace/images/sprite.svg#zoom-in-24') }}"></use>
                                        </svg></button>
                            ...
                            --> <a href="{{ asset('marketplace/images/products/product-16.jpg')}}" data-width="700" data-height="700"
                                                class="product-image__body" target="_blank"><img class="product-image__img"
                                                    src="{{ asset('marketplace/images/products/product-16.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="product-image product-image--location--gallery">
                                            <!--
                            The data-width and data-height attributes must contain the size of a larger version
                            ...
                            attribute, in which case the width and height will be obtained from the naturalWidth
                            and naturalHeight property of img.product-image__img.
                            --> <a href="{{ asset('marketplace/images/products/product-16-1.jpg')}}" data-width="700" data-height="700"
                                                class="product-image__body" target="_blank"><img class="product-image__img"
                                                    src="{{ asset('marketplace/images/products/product-16-1.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="product-image product-image--location--gallery">
                                            <!--
                            The data-width and data-height attributes must contain the size of a larger version
                            ...
                            attribute, in which case the width and height will be obtained from the naturalWidth
                            and naturalHeight property of img.product-image__img.
                            --> <a href="{{ asset('marketplace/images/products/product-16-2.jpg')}}" data-width="700" data-height="700"
                                                class="product-image__body" target="_blank"><img class="product-image__img"
                                                    src="{{ asset('marketplace/images/products/product-16-2.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="product-image product-image--location--gallery">
                                            <!--
                            The data-width and data-height attributes must contain the size of a larger version
                            ...
                            attribute, in which case the width and height will be obtained from the naturalWidth
                            and naturalHeight property of img.product-image__img.
                            --> <a href="{{ asset('marketplace/images/products/product-16-3.jpg')}}" data-width="700" data-height="700"
                                                class="product-image__body" target="_blank"><img class="product-image__img"
                                                    src="{{ asset('marketplace/images/products/product-16-3.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="product-image product-image--location--gallery">
                                            <!--
                            The data-width and data-height attributes must contain the size of a larger version
                            ...
                            attribute, in which case the width and height will be obtained from the naturalWidth
                            and naturalHeight property of img.product-image__img.
                            --> <a href="{{ asset('marketplace/images/products/product-16-4.jpg')}}" data-width="700" data-height="700"
                                                class="product-image__body" target="_blank"><img class="product-image__img"
                                                    src="{{ asset('marketplace/images/products/product-16-4.jpg')}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-gallery__carousel">
                                    <div class="owl-carousel" id="product-carousel"><a
                                            href="{{ asset('marketplace/images/products/product-16.jpg')}}"
                                            class="product-image product-gallery__carousel-item">
                                            <div class="product-image__body"><img
                                                    class="product-image__img product-gallery__carousel-image"
                                                    src="{{ asset('marketplace/images/products/product-16.jpg')}}" alt=""></div>
                                        </a><a href="{{ asset('marketplace/images/products/product-16-1.jpg')}}"
                                            class="product-image product-gallery__carousel-item">
                                            <div class="product-image__body"><img
                                                    class="product-image__img product-gallery__carousel-image"
                                                    src="{{ asset('marketplace/images/products/product-16-2.jpg')}}" alt=""></div>
                                        </a><a href="{{ asset('marketplace/images/products/product-16-2.jpg')}}"
                                            class="product-image product-gallery__carousel-item">
                                            <div class="product-image__body"><img
                                                    class="product-image__img product-gallery__carousel-image"
                                                    src="{{ asset('marketplace/images/products/product-16-2.jpg')}}" alt=""></div>
                                        </a><a href="{{ asset('marketplace/images/products/product-16-3.jpg')}}"
                                            class="product-image product-gallery__carousel-item">
                                            <div class="product-image__body"><img
                                                    class="product-image__img product-gallery__carousel-image"
                                                    src="{{ asset('marketplace/images/products/product-16-3.jpg')}}" alt=""></div>
                                        </a><a href="{{ asset('marketplace/images/products/product-16-4.jpg')}}"
                                            class="product-image product-gallery__carousel-item">
                                            <div class="product-image__body"><img
                                                    class="product-image__img product-gallery__carousel-image"
                                                    src="{{ asset('marketplace/images/products/product-16-4.jpg')}}" alt=""></div>
                                        </a></div>
                                </div>
                            </div>
                                ...
                                <div class="form-group product__option"><label class="product__option-label"
                                    ...
                                    <div class="product__actions">
                                        ...
                                        <div class="product__actions-item product__actions-item--wishlist"><button
                                                ...
                                                data-toggle="tooltip" title="Wishlist"><svg width="16px" height="16px">
                                                    <use xlink:href="images/sprite.svg#wishlist-16"></use>
                                                </svg></button></div>
                                        <div class="product__actions-item product__actions-item--compare"><button
                                                type="button" class="btn btn-secondary btn-svg-icon btn-lg"
                                                data-toggle="tooltip" title="Compare"><svg width="16px" height="16px">
                                                    <use xlink:href="images/sprite.svg#compare-16"></use>
                                                </svg></button></div>
                                    </div>
                                </div>
