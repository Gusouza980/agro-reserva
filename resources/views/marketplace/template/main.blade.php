...
<!-- Mirrored from stroyka.html.themeforest.scompiler.ru/themes/black-ltr/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Feb 2022 18:53:37 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('marketplace/vendor/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('marketplace/vendor/owl-carousel/assets/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('marketplace/vendor/photoswipe/photoswipe.css') }}">
    <link rel="stylesheet" href="{{ asset('marketplace/vendor/photoswipe/default-skin/default-skin.css') }}">
    <link rel="stylesheet" href="{{ asset('marketplace/vendor/select2/css/select2.min.css') }}">
    <link rel="stylesheet" href="{{ asset('marketplace/css/style.css') }}"><!-- font - fontawesome -->
    <link rel="stylesheet" href="{{ asset('marketplace/vendor/fontawesome/css/all.min.css') }}"><!-- font - stroyka -->
    <link rel="stylesheet" href="{{ asset('marketplace/fonts/stroyka/stroyka.css') }}">
...
<body>
                ...
                <div class="mobile-header__panel">
                    <div class="container">
                        <div class="mobile-header__body"><button class="mobile-header__menu-button"><svg width="18px"
                                    height="14px">
                                    <use xlink:href="{{ asset('marketplace/images/sprite.svg#menu-18x14') }}"></use>
                                </svg></button> <a class="mobile-header__logo" href="index.html">
                                <!-- mobile-logo --> <svg xmlns="http://www.w3.org/2000/svg" width="120px"
                                    height="20px">
                                ...
                                <div class="search__body">
                                    <form class="search__form" action="#"><input class="search__input" name="search"
                                            ...
                                            class="search__button search__button--type--submit" type="submit"><svg
                                                ...
                                                <use xlink:href="{{ asset('marketplace/images/sprite.svg#search-20') }}"></use>
                                            </svg></button> <button class="search__button search__button--type--close"
                                            type="button"><svg width="20px" height="20px">
                                                <use xlink:href="{{ asset('marketplace/images/sprite.svg#cross-20') }}"></use>
                                            </svg></button>
                            ...
                            <div class="mobile-header__indicators">
                                ...
                                <div class="indicator indicator--mobile d-sm-flex d-none"><a href="wishlist.html"
                                        class="indicator__button"><span class="indicator__area"><svg width="20px"
                                                height="20px">
                                                <use xlink:href="{{ asset('marketplace/images/sprite.svg#heart-20') }}"></use>
                                            </svg> <span class="indicator__value">0</span></span></a></div>
                                <div class="indicator indicator--mobile"><a href="cart.html"
                                        class="indicator__button"><span class="indicator__area"><svg width="20px"
                                                height="20px">
                                                <use xlink:href="{{ asset('marketplace/images/sprite.svg#cart-20') }}"></use>
            ...
            <div class="site-header">
                    ...
                    <div class="topbar__container container">
                        <div class="topbar__row">
                            <div class="topbar__item topbar__item--link"><a class="topbar-link"
                                    href="about-us.html">Sobre Nós</a></div>
                            <div class="topbar__item topbar__item--link"><a class="topbar-link"
                                    href="contact-us.html">Contato</a></div>
                            <div class="topbar__item topbar__item--link"><a class="topbar-link" href="#">Store
                                    Location</a></div>
                            <div class="topbar__item topbar__item--link"><a class="topbar-link"
                                    href="track-order.html">Rastrear Pedido</a></div>
                            <div class="topbar__item topbar__item--link"><a class="topbar-link"
                                    href="blog-classic.html">Blog</a></div>
                            <div class="topbar__spring"></div>
                            <div class="topbar__item">
                                <div class="topbar-dropdown"><button class="topbar-dropdown__btn" type="button">Minha Conta <svg width="7px" height="5px">
                                            <use xlink:href="{{ asset('marketplace/images/sprite.svg#arrow-rounded-down-7x5') }}"></use>
                                        </svg></button>
                                        ...
                                        <div class="menu menu--layout--topbar">
                                            ...
                                            <ul class="menu__list">
                                                ...
                                                <li class="menu__item">
                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                    <div class="menu__item-submenu-offset"></div><a
                                                        class="menu__item-link" href="account-profile.html">Edit
                                                        Profile</a>
                                                </li>
                                                <li class="menu__item">
                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                    <div class="menu__item-submenu-offset"></div><a
                                                        class="menu__item-link" href="account-orders.html">Order
                                                        History</a>
                                                </li>
                                                <li class="menu__item">
                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                    <div class="menu__item-submenu-offset"></div><a
                                                        class="menu__item-link"
                                                        href="account-addresses.html">Addresses</a>
                                                </li>
                                                <li class="menu__item">
                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                    <div class="menu__item-submenu-offset"></div><a
                                                        class="menu__item-link"
                                                        href="account-password.html">Password</a>
                                                </li>
                                                <li class="menu__item">
                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                    <div class="menu__item-submenu-offset"></div><a
                                                        class="menu__item-link" href="account-login.html">Logout</a>
                                                </li>
                                            </ul>
                                        </div><!-- .menu / end -->
                                    </div>
                ...
                <div class="site-header__middle container">
                    <div class="site-header__logo"><a href="index.html">
                            <!-- logo --> 
                            <img src="{{ asset('imagens/logo_agroreserva_leite_escura.svg') }}" width="150" alt="">
                        </a></div>
                    <div class="site-header__search">
                        <div class="search search--location--header">
                            <div class="search__body">
                                <form class="search__form" action="#"><select class="search__categories"
                                        aria-label="Category">
                                        <option value="all">Categorias</option>
                                        <option>Embrião</option>
                                        ...
                                        placeholder="Pesquise aqui o que deseja" aria-label="Site search" type="text"
                    ...
                    <div class="site-header__phone">
                        <div class="site-header__phone-title">Fale com um consultor</div>
                        <div class="site-header__phone-number">(35) 98846-1456</div>
                    </div>
                </div>
                                    ...
                                    <div class="departments"
                                        ...
                                        <div class="departments__body">
                                            <div class="departments__links-wrapper">
                                                ...
                                                <ul class="departments__links">
                                                    <li class="departments__item"><a class="departments__item-link"
                                                            href="#">Embriões <svg
                                                                ...
                                                                height="9px">
                                                                <use
                                                                    xlink:href="{{ asset('marketplace/images/sprite.svg#arrow-rounded-right-6x9') }}">
                                                                </use>
                                                            </svg></a>
                                                        <div
                                                                                ...
                                                                                <li
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li class="megamenu__item"><a
                                                                                                href="#">Embrião tipo 1</a>
                                                                                        </li>
                                                                                        <li class="megamenu__item"><a
                                                                                                href="#">Embrião tipo 1</a>
                                                                                        </li>
                                                                                        <li class="megamenu__item"><a
                                                                                                href="#">Embrião tipo 1</a></li>
                                                                                        <li class="megamenu__item"><a
                                                                                                href="#">Embrião tipo 1</a></li>
                                                                                        <li class="megamenu__item"><a
                                                                                                href="#">Embrião tipo 1</a>
                                                ...
                                                <use xlink:href="{{ asset('marketplace/images/sprite.svg#menu-18x14') }}"></use>
                                            </svg> Compre por Categoria <svg class="departments__button-arrow" width="9px"
                                                height="6px">
                                ...
                                <div class="nav-panel__nav-links nav-links">
                                    <ul class="nav-links__list">
                                        <li class="nav-links__item"><a class="nav-links__item-link"
                                            ...
                                            <div class="nav-links__item-body">Início</div>
                                        </a></li>
                                        <li class="nav-links__item"><a class="nav-links__item-link"
                                            href="https://themeforest.net/item/stroyka-tools-store-html-template/23326943">
                                            <div class="nav-links__item-body">Produtos</div>
                                        </a></li>
                                    </ul>
                                </div><!-- .nav-links / end -->
                                <div class="nav-panel__indicators">
                                    ...
                                    <div class="indicator indicator--trigger--click"><a href="cart.html"
                                            class="indicator__button"><span class="indicator__area"><svg width="20px"
                                                    height="20px">
                                                    <use xlink:href="{{ asset('marketplace/images/sprite.svg#cart-20')}}"></use>
                                                </svg> <span class="indicator__value">1</span></span></a>
                                            ...
                                            <div class="dropcart dropcart--style--dropdown">
                                                <div class="dropcart__body">
                                                    ...
                                                    <div class="dropcart__buttons"><a class="btn btn-secondary"
                                                            href="cart.html">Ver Carrinho</a> <a class="btn btn-primary"
                                                            href="checkout.html">Finalizar</a></div>
                                                </div>
                                            </div><!-- .dropcart / end -->
                                        </div>
                                    </div>
                                    <div class="indicator indicator--trigger--click"><a href="account-login.html"
                                            class="indicator__button"><span class="indicator__area"><svg width="20px"
                                                    height="20px">
                                                    <use xlink:href="{{ asset('marketplace/images/sprite.svg#person-20') }}"></use>
                                                </svg></span></a>
                                        <div class="indicator__dropdown">
                                            <div class="account-menu">
                                                <form class="account-menu__form">
                                                    <div class="account-menu__form-title">Faça seu Login</div>
                                                    ...
                                                    <div class="form-group"><label for="header-signin-password"
                                                        ...
                                                        <div class="account-menu__form-forgot"><input
                                                                ...
                                                                class="form-control form-control-sm"
                                                                placeholder="Senha"> <a href="#"
                                                                class="account-menu__form-forgot-link">Esqueceu a senha?</a></div>
                                                    </div>
                                                    ...
                                                    <div class="account-menu__form-link"><a
                                                            href="account-login.html">Criar uma conta</a></div>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="container">
                            ...
                            <div class="col-12 col-md-12 col-lg-4">
                                <div class="site-footer__widget footer-newsletter">
                                    ...
                                    <div class="footer-newsletter__text footer-newsletter__text--social">Follow us on
                                        social networks</div><!-- social-links -->
                                    <div
                    ...
                    <div class="site-footer__bottom">
                        <div class="site-footer__copyright">
                            <!-- copyright --> Powered by HTML — Design by <a href="https://themeforest.net/user/kos9"
                ...
                <div class="totop">
                    <div class="totop__body">
                        ...
                        <div class="totop__end"><button type="button" class="totop__button"><svg width="13px"
                                    height="8px">
                                    <use xlink:href="{{ asset('marketplace/images/sprite.svg#arrow-rounded-up-13x8') }}"></use>
                                </svg></button></div>
                    </div>
                </div>
            </div>
    ...
    <!-- js -->
    <script src="{{ asset('marketplace/vendor/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('marketplace/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('marketplace/vendor/owl-carousel/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('marketplace/vendor/nouislider/nouislider.min.js') }}"></script>
    <script src="{{ asset('marketplace/vendor/photoswipe/photoswipe.min.js') }}"></script>
    <script src="{{ asset('marketplace/vendor/photoswipe/photoswipe-ui-default.min.js') }}"></script>
    <script src="{{ asset('marketplace/vendor/select2/js/select2.min.js') }}"></script>
    <script src="{{ asset('marketplace/js/number.js') }}"></script>
    <script src="{{ asset('marketplace/js/main.js') }}"></script>
    <script src="{{ asset('marketplace/js/header.js') }}"></script>
    <script src="{{ asset('marketplace/vendor/svg4everybody/svg4everybody.min.js') }}"></script>
    <script>svg4everybody();</script>
</body>
<!-- Mirrored from stroyka.html.themeforest.scompiler.ru/themes/black-ltr/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Feb 2022 18:54:05 GMT -->
