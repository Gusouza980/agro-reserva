...
class CreateConsultaChequeInternosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('consulta_cheque_internos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('consulta_cheque_internos');
    }
}
