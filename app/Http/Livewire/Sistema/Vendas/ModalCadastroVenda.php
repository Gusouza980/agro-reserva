...
class ModalCadastroVenda extends Component
{
    ...
    public function render()
    {
        ...
        if($this->op == "listagem_clientes"){
            ...
            return view('livewire.sistema.vendas.modal-cadastro-venda', ["clientes" => $clientes]);
            ...
            return view('livewire.sistema.vendas.modal-cadastro-venda', ['lotes' => $lotes]);
        }
        return view('livewire.sistema.vendas.modal-cadastro-venda');
    }
}
